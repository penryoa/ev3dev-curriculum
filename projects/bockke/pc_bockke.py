...
def buttons():
    ...
    find_them_button.grid(row=6, column=0)
    ...
    grab_them_button.grid(row=7, column=0)
    ...
    place_them_button.grid(row=8, column=0)
    ...
    background_music_button.grid(row=9, column=0)
